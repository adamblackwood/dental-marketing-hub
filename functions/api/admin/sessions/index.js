...
export async function onRequestGet(context) {
  try {
    ...
    const res = await fetch(`${SUPABASE_URL}/rest/v1/sessions?select=session_id,uid,started_at,duration_sec,max_scroll_pct,is_bounce,device_type,country,city&order=started_at.desc&offset=${from}&limit=${limit}`, {
