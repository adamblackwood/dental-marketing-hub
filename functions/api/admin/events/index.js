...
export async function onRequestGet(context) {
  try {
    ...
    const res = await fetch(`${SUPABASE_URL}/rest/v1/events?select=event_id,uid,session_id,event_type,event_value,created_at&order=created_at.desc&offset=${from}&limit=${limit}`, {
